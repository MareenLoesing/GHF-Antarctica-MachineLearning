...
#plotting(Data_o.Lon,Data_o.Lat,Data_o.Bz5,'[nT]','Bz at 5km',-200,200,Attempt,Run)
#plotting(Data_o.Lon,Data_o.Lat,Data_o.Bz5,'[km]','Curie',0,60,Attempt,Run)
...
#Data = Data_o[['HF','Lon','Lat', 'IsoCorrAnomaly', 'MeanCurv', 'SI_TopoIso', 
#               'LAB', 'LAB_LitMod', 'LAB_LitMod_Aus17', 'LAB_AN1', 'Moho', 'Moho_AN1',
#               'Moho_AN1_Aus17_Afr', 'Moho_LitMod_Aus17_Afr', 'Topo', 'Tectonics', 'Ridge', 
#               'Transform', 'Trench', 'YoungRift', 'Volcanos', 'MagAnomaly', 
#               'Sus', 'Sus_AN1', 'Sus_AN1_Aus17_Afr',
#               'Sus_LitMod_Aus17_Afr',
#               'Bz5', 'IceTopography', 'Curie']]
...
#Features = ['Volcanos', 'Moho_AN1-Shen_Aus17_Afr', 'Trench', 'LAB_AN1', 'Ridge',
#            'Transform','MeanCurv','YoungRift','Sus_AN1-Shen_Aus17_Afr', 'Bz5',
#            'Topo', 'Tectonics']

#Features = ['Volcanos', 'Moho_LitMod_Aus17_Afr', 'Trench', 'LAB_LitMod', 'Ridge',
...
#PLOT IMPORTANCES##############################################################
#names = ['Volcanos', 'Moho', 'Trench', 'LAB', 'Ridge','Transform','Mean Curvature',
#         'Young Rift','Susceptibility', 'B5', 'Topography', 'Tectonics']
